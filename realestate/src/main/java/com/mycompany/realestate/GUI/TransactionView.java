// GUI transaction used for transaction mangment
...
public class TransactionView extends JFrame {
    ...
    JTextArea area = new JTextArea(); // display area 
    ...
    public TransactionView() {
        setTitle("Transaction Management"); // title window
        setSize(900,600);
        ...
        show.addActionListener(e -> {
         ...
         // action listener for enter Export
