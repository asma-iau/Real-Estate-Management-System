// GUI client used for client mangment 
...
public class ClientView extends JFrame {
    ...
    JTextArea area = new JTextArea(); // area used for display client
    ...
    public ClientView() {
        setTitle("Client Management"); // title window
        ...
        area.setEditable(false); // disable edting 
