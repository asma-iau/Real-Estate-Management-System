// login gui for user authentication , allows user to login 
...
public class LoginGUI extends JFrame {
     public LoginGUI(){
        setTitle("Real Estate Login"); // title window
        ...
        // login  button with size and font and color
        ...
        // create button with size and font and color
